...
Por fim, alguns apêndices contêm informações úteis sobre a linguagem em um formato mais voltado a referência. O [**Apêndice A**](/livro/cap22-01-palavras-chave) cobre as palavras-chave do Rust, o [**Apêndice B**](/livro/cap22-02-operadores-e-simbolos) cobre os operadores e símbolos do Rust, o [**Apêndice C**](/livro/cap22-03-traits-derivaveis) cobre as traits deriváveis fornecidas pela biblioteca padrão, o [**Apêndice D**](/livro/cap22-04-ferramentas-de-desenvolvimento-uteis) cobre algumas ferramentas úteis de desenvolvimento, e o [**Apêndice E**](/livro/cap22-05-edicoes) explica as edições do Rust. No [**Apêndice F**](/livro/cap22-06-traducoes-do-livro), você pode encontrar traduções do livro, e no [**Apêndice G**](/livro/cap22-07-como-o-rust-e-feito-e-nightly-rust) abordaremos como o Rust é desenvolvido e o que é o Rust nightly.
