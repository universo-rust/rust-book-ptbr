...
A segunda nova linha imprime o número secreto. Isso é útil enquanto estamos desenvolvendo o programa para poder testá-lo, mas o deletaremos da versão final. Não é bem um jogo se o programa imprime a resposta assim que começa!
...
Vamos percorrer um exemplo com a expressão `match` que usamos aqui. Digamos que o usuário chutou 50 e o número secreto gerado aleatoriamente desta vez é 38.
