...
Se tudo estiver correto e o Rust ainda não funcionar, há vários lugares onde você pode obter ajuda. Veja como entrar em contato com outros Rustaceans (um apelido divertido que usamos) na página da comunidade [(em inglês)](https://www.rust-lang.org/community) ou [(em português)](https://universorust.com.br/comunidade).
